<!-- page content -->
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="control-label col-md-2" for="first-name">NIP 
                        </label>
                        <div class="col-md-10">
                          <input type="text" id="nip" class="form-control col-md-7 col-xs-12" name="nip">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-2">MatKul</label>
                        <div class="col-md-10">
                          <input id="matkul" class="form-control col-md-7 col-xs-12" type="text" name="matkul">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10">
                          <input id="telepon" class="form-control col-md-7 col-xs-12" type="text" name="tlp">
                        </div>
                      </div>
                    </div>
      ...
      <script type="text/javascript">
        function ajukan() {
          $.ajax({
            url : "<?php echo site_url('admin/Cadmin/simpan_dsn')?>",
            type: "POST",
