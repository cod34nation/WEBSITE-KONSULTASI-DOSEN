              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Menu <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<?=site_url('admin/Cadmin');?>">Daftar Dosen</a>
                    </li> 
                    <li><a href="<?=site_url('admin/Cadmin/informasi');?>">Informasi Admin</a>
                    </li>
                    <li><a href="<?=site_url('admin/Cadmin/profil_dsn');?>">Pengaturan Dosen</a>
                    </li>
                    <li><a href="<?=site_url('admin/Cadmin/profil_mhs');?>">Pengaturan Mahasiswa</a>
                    </li>
                  </ul>
                </li>                
              </ul>
