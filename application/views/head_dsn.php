      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo site_url('dsn/Cdsn');?>" class="site_title"><span>Dosen</span></a>
          </div>
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Menu <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="<?=site_url('dsn/Cdsn');?>">Daftar Pengajuan</a>
                    </li><!-- 
                    <li><a href="<?=site_url('mhs/Cdsn/konsul');?>">Konsultasi</a>
                    </li> -->
                    <li><a href="<?=site_url('dsn/Cdsn/profil');?>">Profil</a>
                    </li>
                    <li><a href="<?=site_url('mhs/Cmhs/infoadmin_dsn');?>">Informasi Admin</a>
                    </li>
                  </ul>
                </li>                
              </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="images/img.jpg" alt=""><?=$this->session->userdata('nama').' ('.$this->session->userdata('nip').')';?>
